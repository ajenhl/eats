...
urlpatterns += patterns(
    ...
    url(r'^entity/(?P<entity_id>\d+)/edit/(?P<assertion_id>\d+)/note/add/$',
        'pa_note_add', name='pa-note-add'),
    url(r'^entity/(?P<entity_id>\d+)/edit/(?P<assertion_id>\d+)/note/(?P<note_id>\d+)/$', 'pa_note_change', name='pa-note-change'),
    url(r'^entity/(?P<entity_id>\d+)/edit/(?P<assertion_id>\d+)/date/(?P<date_id>\d+)/note/add/$', 'date_note_add', name='date-note-add'),
    url(r'^entity/(?P<entity_id>\d+)/edit/(?P<assertion_id>\d+)/date/(?P<date_id>\d+)/note/(?P<note_id>\d+)/$', 'date_note_change', name='date-note-change'),
