...
class EATSTopicMap (TopicMap):
    ...
    @property
    def is_note_internal (self):
        """Returns the is_note_internal topic, that is used as a scoping topic
        for all internal notes.

        :rtype: `Topic`

        """
        return self.create_topic_by_subject_identifier(Locator(
            IS_NOTE_INTERNAL_IRI), '_is_note_internal')
